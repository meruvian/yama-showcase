					...
					<ul class="sidebar-menu">
						...
						<li class="treeview">
							<a href="#">
								...
								<span><@s.text name="menu.main.conference" /></span>
								<i class="fa fa-angle-left pull-right"></i>
							</a>
							<ul class="treeview-menu">
								<li><a href="<@s.url value="/conferences" />"><i class="fa fa-angle-double-right"></i> <@s.text name="menu.main.conference.room" /></a></li>
							</ul>
						</li>
						<#if isAdmin>
						<li class="treeview">
